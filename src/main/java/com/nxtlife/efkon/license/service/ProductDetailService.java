...
public interface ProductDetailService {
     ...
     * @throws ValidationException if product family id or product code id or version id not exist
     */

    public ProductDetailResponse save(ProductDetailRequest request);

    /**
     * this method used to update product detail. It throws exception if product detail id
     * isn't correct
     *
     * @param id
     * @param request
     * @return {@link ProductDetailResponse} after updating product detail information
     * @throws NotFoundException   if product detail id isn't correct
     * @throws ValidationException if product family is update or product code or version id not exist
     */

    public ProductDetailResponse update(Long id, ProductDetailRequest request);

    /**
     * this method used to delete product detail. It throws exception if product detail id not found
     *
     * @param id
