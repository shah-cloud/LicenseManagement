...
public interface ProductFamilyService {
     ...
     * @param id
     * @param request
     * @return {@link ProductFamilyResponse} after updating product family information
    ...
    /**
     * this method used to delete product family. It throws exception if product family id not found
     *
     * @param id
